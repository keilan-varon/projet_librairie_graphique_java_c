...
public class DessineFormeCORRectangleRempliCouleur extends  DessineFormeCOR{
    final static String NAME_FIGURE = "rectangle";

    DessineFormeCORRectangleRempliCouleur(DessineFormeCOR suivant,Graphics graphics){
